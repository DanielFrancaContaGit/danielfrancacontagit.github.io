...
import { _ as __nuxt_component_0$2 } from "./projetos-jpRZlK1k.js";
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    ...
                    _push4(ssrRenderComponent(_component_v_card_title, { class: "text-white text-subtitle-1 mt-3 mb-20" }, {
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          _push5(` Feito por Daniel França `);
                        } else {
                          return [
                            createTextVNode(" Feito por Daniel França ")
                          ];
                        }
                      }),
                      _: 1
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              ...
              _push3(ssrRenderComponent(_component_v_card_text, null, {
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(` Oi, sou um estudante de Engenharia Eletrônica e apaixonado por desenvolvimento. Aqui, compartilho meu percurso de aprendizado, explorando as interseções entre eletrônica e programação. De projetos simples a desafios mais complexos, cada linha de código representa meu compromisso com o crescimento profissional. Meu interesse abrange áreas como backend, frontend, devops e machinelearning. Estou sempre em busca de novas ferramentas e linguagens para expandir minhas habilidades. `);
                  } else {
                    return [
                      createTextVNode(" Oi, sou um estudante de Engenharia Eletrônica e apaixonado por desenvolvimento. Aqui, compartilho meu percurso de aprendizado, explorando as interseções entre eletrônica e programação. De projetos simples a desafios mais complexos, cada linha de código representa meu compromisso com o crescimento profissional. Meu interesse abrange áreas como backend, frontend, devops e machinelearning. Estou sempre em busca de novas ferramentas e linguagens para expandir minhas habilidades. ")
                    ];
                  }
                }),
                _: 1
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  const _component_Projetos = __nuxt_component_0$2;
...
//# sourceMappingURL=index-dz80TImK.js.map
