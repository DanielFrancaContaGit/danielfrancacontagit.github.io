import { version as version$1, unref, inject as inject$1, createVNode, mergeProps, Transition, toRefs, shallowRef, ref, computed, watch, nextTick, toRef, watchEffect, provide, onScopeDispose, withDirectives, vShow, Fragment, resolveDirective, reactive, onUnmounted, createTextVNode, capitalize, h, defineComponent as defineComponent$1, shallowReactive, Suspense, hasInjectionContext, camelize, getCurrentInstance as getCurrentInstance$1, toRaw, readonly, TransitionGroup, isRef, Text, resolveDynamicComponent, effectScope, warn, Teleport, cloneVNode, withModifiers, toDisplayString, vModelText, resolveComponent, useSSRContext, createApp, isVNode, Comment, defineAsyncComponent, onErrorCaptured, onServerPrefetch, isReadonly, isShallow, isReactive, withCtx } from 'file:///home/daniel/Documentos/Projetos/full-stack/nuxt/mypage/node_modules/vue/index.mjs';
import { $fetch } from 'file:///home/daniel/Documentos/Projetos/full-stack/nuxt/mypage/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file:///home/daniel/Documentos/Projetos/full-stack/nuxt/mypage/node_modules/hookable/dist/index.mjs';
import { getContext } from 'file:///home/daniel/Documentos/Projetos/full-stack/nuxt/mypage/node_modules/unctx/dist/index.mjs';
import { getActiveHead } from 'file:///home/daniel/Documentos/Projetos/full-stack/nuxt/mypage/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///home/daniel/Documentos/Projetos/full-stack/nuxt/mypage/node_modules/@unhead/shared/dist/index.mjs';
import { useRoute as useRoute$2, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///home/daniel/Documentos/Projetos/full-stack/nuxt/mypage/node_modules/vue-router/dist/vue-router.node.mjs';
import { createError as createError$1, sanitizeStatusCode } from 'file:///home/daniel/Documentos/Projetos/full-stack/nuxt/mypage/node_modules/h3/dist/index.mjs';
import { hasProtocol, joinURL, parseURL, parseQuery, withQuery, isScriptProtocol, withTrailingSlash, withoutTrailingSlash } from 'file:///home/daniel/Documentos/Projetos/full-stack/nuxt/mypage/node_modules/ufo/dist/index.mjs';
import { defu } from 'file:///home/daniel/Documentos/Projetos/full-stack/nuxt/mypage/node_modules/defu/dist/defu.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs } from 'file:///home/daniel/Documentos/Projetos/full-stack/nuxt/mypage/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-ODhryQWq.mjs').then((m) => m.default || m)
  },
  {
    name: "projetos",
    path: "/projetos",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/projetos-MMGMYJrz.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404--7ZXbAeB.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./_nuxt/error-500-5MPVAZyz.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./_nuxt/island-renderer-sB8lCBAu.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
