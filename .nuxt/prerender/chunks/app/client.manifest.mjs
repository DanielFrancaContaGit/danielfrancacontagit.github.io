const client_manifest = {
  "_vue.f36acd1f.NjLmcBek.js": {
    "resourceType": "script",
    "module": true,
    "prefetch": true,
    "preload": true,
    "file": "vue.f36acd1f.NjLmcBek.js",
    "imports": [
