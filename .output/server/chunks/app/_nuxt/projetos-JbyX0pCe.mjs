import { useSSRContext, ref, resolveComponent, withCtx, createVNode, unref, toDisplayString, openBlock, createBlock, Fragment, renderList, mergeProps, createTextVNode } from 'vue';
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_v_row, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h1 class="text-h2 text-blue-grey-darken-4"${_scopeId2}>Projetos</h1>`);
                } else {
                  return [
                    createVNode("h1", { class: "text-h2 text-blue-grey-darken-4" }, "Projetos")
                  ];
                }
              }),
              _: 1
...
//# sourceMappingURL=projetos-JbyX0pCe.mjs.map
